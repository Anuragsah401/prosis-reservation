...
export function ReservationsStats({ reservations }: ReservationsStatsProps) {
  ...
  return (
    <div className="grid grid-cols-2 gap-2 sm:grid-cols-4 sm:gap-1.5 md:gap-2 lg:gap-3">
      ...
      <Card className="min-w-0 border-border/80 bg-card shadow-xs transition-all hover:border-border hover:shadow-sm">
        <CardContent className="p-2 sm:p-1.5 sm:py-1 md:p-2 md:py-1.5 lg:p-3.5">
          <div className="flex items-center justify-between gap-1">
            ...
            <div className="flex size-5.5 sm:size-5 md:size-6 shrink-0 items-center justify-center rounded-md bg-primary/10 text-primary">
              <Users className="size-3 sm:size-3 md:size-3.5" />
            </div>
          </div>
          <div className="mt-0.5 flex items-baseline gap-1 sm:gap-1.5 flex-wrap">
            <span className="text-base sm:text-base md:text-lg lg:text-xl font-bold tracking-tight text-foreground">
              {totalCovers}
            </span>
            <span className="text-[10px] sm:text-[10px] md:text-xs font-medium text-muted-foreground truncate">
              {t("pages.reservations.stats.totalCovers", "{{count}} covers", { count: totalCovers })}
            </span>
          </div>
          <p className="text-muted-foreground mt-0.5 text-[10px] sm:text-[10px] md:text-[11px] truncate">
      ...
      <Card className="min-w-0 border-border/80 bg-card shadow-xs transition-all hover:border-border hover:shadow-sm">
        <CardContent className="p-2 sm:p-1.5 sm:py-1 md:p-2 md:py-1.5 lg:p-3.5">
          <div className="flex items-center justify-between gap-1">
            ...
            <div className="flex size-5.5 sm:size-5 md:size-6 shrink-0 items-center justify-center rounded-md bg-emerald-500/10 text-emerald-600 dark:text-emerald-400">
              <CheckCircle2 className="size-3 sm:size-3 md:size-3.5" />
            </div>
          </div>
          <div className="mt-0.5 flex items-baseline gap-1 sm:gap-1.5 flex-wrap">
            <span className="text-base sm:text-base md:text-lg lg:text-xl font-bold tracking-tight text-foreground">
            ...
            <span className="text-[10px] sm:text-[10px] md:text-xs font-medium text-emerald-600 dark:text-emerald-400 truncate">
      ...
      <Card className="min-w-0 border-border/80 bg-card shadow-xs transition-all hover:border-border hover:shadow-sm">
        <CardContent className="p-2 sm:p-1.5 sm:py-1 md:p-2 md:py-1.5 lg:p-3.5">
          <div className="flex items-center justify-between gap-1">
            ...
            <div className="flex size-5.5 sm:size-5 md:size-6 shrink-0 items-center justify-center rounded-md bg-amber-500/10 text-amber-600 dark:text-amber-400">
              <AlertCircle className="size-3 sm:size-3 md:size-3.5" />
            </div>
          </div>
          <div className="mt-0.5 flex items-baseline gap-1 sm:gap-1.5 flex-wrap">
            <span className="text-base sm:text-base md:text-lg lg:text-xl font-bold tracking-tight text-foreground">
      ...
      <Card className="min-w-0 border-border/80 bg-card shadow-xs transition-all hover:border-border hover:shadow-sm">
        <CardContent className="p-2 sm:p-1.5 sm:py-1 md:p-2 md:py-1.5 lg:p-3.5">
          <div className="flex items-center justify-between gap-1">
            ...
            <div className="flex size-5.5 sm:size-5 md:size-6 shrink-0 items-center justify-center rounded-md bg-purple-500/10 text-purple-600 dark:text-purple-400">
              <UtensilsCrossed className="size-3 sm:size-3 md:size-3.5" />
            </div>
          </div>
          <div className="mt-0.5 flex items-baseline gap-1 sm:gap-1.5 flex-wrap">
            <span className="text-base sm:text-base md:text-lg lg:text-xl font-bold tracking-tight text-foreground">

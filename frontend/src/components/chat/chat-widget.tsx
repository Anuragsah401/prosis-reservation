...
import {
  WHATSAPP_NUMBER as OWNER_WHATSAPP_NUMBER,
  WHATSAPP_DISPLAY_PHONE as OWNER_DISPLAY_PHONE,
} from "@/lib/config"
...
function WhatsAppIcon({ className = "size-4" }: { className?: string }) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M17.472 14.382c-.301-.15-1.78-.878-2.056-.979-.276-.1-.476-.15-.676.15-.2.3-.776.979-.952 1.18-.175.2-.35.226-.651.075-.3-.15-1.267-.467-2.414-1.49-1.002-.892-1.678-1.994-1.874-2.332-.196-.338-.021-.52.13-.67.135-.135.301-.35.451-.526.15-.175.2-.3.301-.5.1-.2.05-.376-.025-.526-.075-.15-.677-1.632-.927-2.235-.244-.588-.493-.509-.677-.518-.175-.01-.376-.01-.577-.01-.2 0-.526.075-.802.376-.276.3-1.053 1.03-1.053 2.51 0 1.48 1.078 2.91 1.229 3.11.15.2 2.12 3.238 5.137 4.542.717.311 1.277.497 1.714.636.721.229 1.377.197 1.895.12.577-.087 1.78-.727 2.03-1.43.25-.702.25-1.303.175-1.43-.075-.126-.276-.201-.577-.351zM12.004 2C6.479 2 2 6.48 2 12.006c0 1.905.534 3.684 1.46 5.203L2 22l4.935-1.428A9.957 9.957 0 0 0 12.004 22c5.526 0 10.006-4.48 10.006-10.004 0-5.526-4.48-10.006-10.006-10.006z" />
    </svg>
  )
}
